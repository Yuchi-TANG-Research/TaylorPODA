...
num_0 = 3
num_1 = 8
downsample_length = 28  # i.e., no downsampling
index = 11
...
optimised_attribution = optimiser.generate_optimised_attribution(
    input=X_TBX, options=16, withMaskModel=1, rank=c, approx=True)
a_PODAc2 = np.round(optimised_attribution['optimized attribution'], 6)
