'''
Reference: https://github.com/iancovert/fastshap/blob/main/fastshap/surrogate.py
'''
import torch
...
class Surrogate:
    ...
    def __call__(self, x, S):
        ...
        try:
            surr_value=self.surrogate((x, S))
        except:
            surr_value=self.surrogate((x, S.long()))
        return surr_value
